...
3. **Run the Main Script**: Execute the `main.py` script will perform the training process for equations `I.6.2b` using Linear(MLP) and CNN models with Mean Squared Error as the loss function, and for both trainin types: clean and noise-aware.
